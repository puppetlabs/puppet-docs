...
*(last generated on Mon Jul 19 21:53:49 -0700 2010)*
...
Send report information via HTTP to the `reporturl`. Each host
sends its report as a YAML dump and this sends this YAML to a
client via HTTP POST. The YAML is the \`report\` parameter of the
request."
...
*This page autogenerated on Mon Jul 19 21:53:49 -0700 2010*
