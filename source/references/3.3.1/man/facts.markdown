...
<a data-bare-link="true" href="http://docs.puppetlabs.com/guides/inventory_service.html">http://docs.puppetlabs.com/guides/inventory_service.html</a> for more detail.</p>
...
<pre><code>When using the `facter` terminus, the host argument is ignored.
</code></pre></dd>
...
<a data-bare-link="true" href="http://docs.puppetlabs.com/guides/rest_auth_conf.html">http://docs.puppetlabs.com/guides/rest_auth_conf.html</a> for more details.</p></dd>
</dl>
