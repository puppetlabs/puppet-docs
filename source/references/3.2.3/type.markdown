...
**This page is autogenerated; any changes will get overwritten** *(last generated on Fri Jul 19 16:06:17 -0700 2013)*
...
: The specific backend to use for this `group`
  ...
  : Group management via `groupadd` and its ilk. The default for most platforms.
    ...
    Required binaries: `lgroupadd`, `groupdel`, `groupmod`, `groupadd`.  Supported features: `system_groups`.
...
: The specific backend to use for this `package`
  ...
  : Installation from an AIX NIM LPP source.  The `source` parameter is required
    ...
    Required binaries: `/usr/bin/lslpp`, `rpm`, `/usr/sbin/nimclient`.  Supported features: `installable`, `uninstallable`, `upgradeable`, `versionable`.
...
: The specific backend to use for this `service`
  ...
  : Support for AIX's System Resource controller.
    ...
    Required binaries: `/usr/sbin/lsitab`, `/usr/bin/refresh`, `/usr/sbin/mkitab`, `/usr/sbin/rmitab`, `/usr/bin/stopsrc`, `/usr/sbin/chitab`, `/usr/bin/startsrc`, `/usr/bin/lssrc`.  Default for `operatingsystem` == `aix`.  Supported features: `enableable`, `refreshable`.
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/status`, `/sbin/initctl`, `/sbin/start`, `/sbin/stop`, `/sbin/restart`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management on OS X.
    ...
    Required binaries: `/usr/bin/dsimport`, `/usr/bin/dscacheutil`, `/usr/bin/dscl`, `/usr/bin/plutil`, `/usr/bin/uuidgen`.  Default for `operatingsystem` == `darwin`.  Supported features: `manages_password_salt`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `rolemod`, `userdel`, `usermod`, `roleadd`, `passwd`, `roledel`, `useradd`.  Default for `osfamily` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
  ...
  : User management via `useradd` and its ilk.  Note that you will need to
    ...
    Required binaries: `luseradd`, `userdel`, `usermod`, `chage`, `useradd`.  Supported features: `allows_duplicates`, `manages_expiry`, `manages_homedir`, `system_users`.
...
*This page autogenerated on Fri Jul 19 16:06:19 -0700 2013*
