...
**This page is autogenerated; any changes will get overwritten** *(last generated on Mon Oct 15 11:47:54 -0700 2012)*
...
: The specific backend to use for this `service`
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/restart`, `/sbin/status`, `/sbin/start`, `/sbin/initctl`, `/sbin/stop`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
*This page autogenerated on Mon Oct 15 11:47:56 -0700 2012*
