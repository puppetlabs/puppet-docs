...
**This page is autogenerated; any changes will get overwritten** *(last generated on Tue Aug 21 17:55:58 -0700 2012)*
...
: The specific backend to use for this `user`
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roledel`, `rolemod`, `userdel`, `passwd`, `usermod`, `useradd`, `roleadd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Tue Aug 21 17:55:59 -0700 2012*
