...
*(last generated on Sat May 08 22:14:03 +1000 2010)*
...
regexp
  ~ The regular expression matching the string. If you want it
    anchored at the start and or end of the string, you must do that
    with \^ and $ yourself.
...
> -   **M** Multiline regexps
> -   **G** Global replacement; all occurrences of the regexp in the
>     string will be replaced. Without this, only the first occurrence
>     will be replaced.
...
*This page autogenerated on Sat May 08 22:14:03 +1000 2010*
