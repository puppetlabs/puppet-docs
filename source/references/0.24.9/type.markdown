...
*(last generated on Wed Dec 23 15:09:44 -0800 2009)*
...
## [Available Metaparameters](#id343)
...
Valid values are time, md5, mtime, md5lite, timestamp. Values can
also match /\^\\{md5|md5lite|timestamp|mtime|time\\}/.
...
-   **netinfo**: Host management in NetInfo.
    ...
    > currently.
    > 
    > Required binaries: umount, df, nireport, niutil, mount. Default for
...
## [nagios\_servicedependency](#id368)
...
## [nagios\_serviceescalation](#id369)
...
-   **appdmg**: Package management which copies application bundles
    to a target. Required binaries: /usr/bin/ditto, /usr/bin/hdiutil,
    /usr/bin/curl. Supported features: installable.
...
-   **urpmi**: Support via urpmi. Required binaries: urpmi, rpm,
...
-   **user\_role\_add**: User management inherits useradd and adds
    ...
    roledel, usermod, rolemod, userdel, useradd, roleadd. Default for
...
*This page autogenerated on Wed Dec 23 15:09:47 -0800 2009*
