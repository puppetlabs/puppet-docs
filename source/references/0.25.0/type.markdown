...
*(last generated on Tue Apr 13 14:17:48 -0400 2010)*
...
-   **netinfo**: Group management using NetInfo.
    ...
    > Required binaries: niutil, nireport.
...
-   **netinfo**: Host management in NetInfo.
    ...
    > currently.
    > 
    > Required binaries: niutil, mount, umount, df, nireport. Default for
...
-   **fink**: Package management via fink. Required binaries:
    ...
    /sw/bin/fink. Supported features: installable, purgeable,
    uninstallable, upgradeable, versionable.
...
-   **user\_role\_add**: User management inherits useradd and adds
    ...
    usermod, rolemod, userdel, roleadd, useradd, roledel. Default for
...
*This page autogenerated on Tue Apr 13 14:17:48 -0400 2010*
