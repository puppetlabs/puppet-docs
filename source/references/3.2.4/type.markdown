...
**This page is autogenerated; any changes will get overwritten** *(last generated on Thu Sep 05 12:07:01 -0700 2013)*
...
: The specific backend to use for this `service`
  ...
  : Support for AIX's System Resource controller.
    ...
    Required binaries: `/usr/sbin/mkitab`, `/usr/sbin/rmitab`, `/usr/bin/stopsrc`, `/usr/bin/refresh`, `/usr/sbin/chitab`, `/usr/bin/startsrc`, `/usr/bin/lssrc`, `/usr/sbin/lsitab`.  Default for `operatingsystem` == `aix`.  Supported features: `enableable`, `refreshable`.
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/start`, `/sbin/stop`, `/sbin/restart`, `/sbin/status`, `/sbin/initctl`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management on OS X.
    ...
    Required binaries: `/usr/bin/dscacheutil`, `/usr/bin/dscl`, `/usr/bin/uuidgen`, `/usr/bin/plutil`, `/usr/bin/dsimport`.  Default for `operatingsystem` == `darwin`.  Supported features: `manages_password_salt`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `passwd`, `usermod`, `roleadd`, `roledel`, `userdel`, `rolemod`, `useradd`.  Default for `osfamily` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
  ...
  : User management via `useradd` and its ilk.  Note that you will need to
    ...
    Required binaries: `chage`, `usermod`, `luseradd`, `userdel`, `useradd`.  Supported features: `allows_duplicates`, `manages_expiry`, `manages_homedir`, `system_users`.
...
*This page autogenerated on Thu Sep 05 12:07:03 -0700 2013*
