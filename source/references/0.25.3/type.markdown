...
*(last generated on Tue Jan 12 17:27:28 -0800 2010)*
...
-   **hpux**: HP-UX's packaging system. Required binaries:
    /usr/sbin/swremove, /usr/sbin/swinstall, /usr/sbin/swlist. Default
...
-   **user\_role\_add**: User management inherits useradd and adds
    ...
    usermod, roledel, rolemod, userdel, roleadd, useradd. Default for
...
*This page autogenerated on Tue Jan 12 17:27:33 -0800 2010*
