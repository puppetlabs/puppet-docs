...
**This page is autogenerated; any changes will get overwritten** *(last generated on Thu Sep 05 12:09:44 -0700 2013)*
...
: The specific backend to use for this `package`
  ...
  : Package management via `fink`.
    ...
    Required binaries: `/sw/bin/apt-cache`, `/sw/bin/dpkg-query`, `/sw/bin/fink`, `/sw/bin/apt-get`.  Supported features: `holdable`, `installable`, `purgeable`, `uninstallable`, `upgradeable`, `versionable`.
  ...
  : Support for FreeBSD's ports.  Note that this, too, mixes packages and ports.
    ...
    Required binaries: `/usr/local/sbin/portversion`, `/usr/local/sbin/pkg_deinstall`, `/usr/sbin/pkg_info`, `/usr/local/sbin/portupgrade`.  Default for `operatingsystem` == `freebsd`.  Supported features: `installable`, `purgeable`, `uninstallable`, `upgradeable`.
  ...
  : Support via `urpmi`.
    ...
    Required binaries: `rpm`, `urpmi`, `urpmq`, `urpme`.  Default for `operatingsystem` == `mandriva, mandrake`.  Supported features: `installable`, `purgeable`, `uninstallable`, `upgradeable`, `versionable`.
...
: The specific backend to use for this `service`
  ...
  : Support for AIX's System Resource controller.
    ...
    Required binaries: `/usr/bin/lssrc`, `/usr/bin/refresh`, `/usr/sbin/lsitab`, `/usr/sbin/mkitab`, `/usr/sbin/rmitab`, `/usr/bin/stopsrc`, `/usr/sbin/chitab`, `/usr/bin/startsrc`.  Default for `operatingsystem` == `aix`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management on OS X.
    ...
    Required binaries: `/usr/bin/dscacheutil`, `/usr/bin/plutil`, `/usr/bin/uuidgen`, `/usr/bin/dscl`, `/usr/bin/dsimport`.  Default for `operatingsystem` == `darwin`.  Supported features: `manages_password_salt`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `passwd`, `roleadd`, `usermod`, `roledel`, `userdel`, `rolemod`, `useradd`.  Default for `osfamily` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Thu Sep 05 12:09:46 -0700 2013*
