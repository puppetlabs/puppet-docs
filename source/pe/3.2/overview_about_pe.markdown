...
The "What Gets Installed Where" page includes a [list of all the major packages that comprise PE 3.2](./install_what_and_where.html#puppet-enterprise-components).
