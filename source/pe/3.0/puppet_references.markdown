...
* [The Type Reference](/puppet/3.2/reference/type.html) is the complete dictionary of Puppet's built-in resource types. No other page will be more useful to you on a daily basis.
...
* [The Configuration Reference](/puppet/3.2/reference/configuration.html) lists every single setting available to Puppet.
