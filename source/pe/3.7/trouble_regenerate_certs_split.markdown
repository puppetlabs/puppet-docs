---
layout: default
title: "PE 3.7 » Deploying PE » Cert Regeneration: Split Deployments"
...
4. Stop the puppet master service with `sudo puppet resource service pe-puppetserver ensure=stopped`.
...
9. Start the puppet master service with `sudo puppet resource service pe-puppetserver ensure=running`.
...
[confdir]: /puppet/3.7/reference/dirs_confdir.html#windows-systems
