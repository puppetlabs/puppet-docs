---
layout: default
title: "PE 3.1 » Accounts Module » The pe_accounts::user Type"
...
Many of the type's parameters echo those of the standard [`user` type](/references/3.3.latest/type.html#user).
