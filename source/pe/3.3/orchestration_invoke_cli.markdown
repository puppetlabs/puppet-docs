...
You can use Puppet's [`ssh_authorized_key` resource type](/puppet/3.4/reference/type.html#sshauthorizedkey) to do this, or add keys manually to the `/var/lib/peadmin/.ssh/authorized_keys` file.
