---
layout: default
title: "PE 3.3 » Orchestration » Invoking Actions"
...
You can use Puppet's [`ssh_authorized_key` resource type](/references/3.4.latest/type.html#sshauthorizedkey) to do this, or add keys manually to the `/var/lib/peadmin/.ssh/authorized_keys` file.
