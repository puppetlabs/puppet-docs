---
layout: default
title: "PE 3.3 » Accounts Module » The pe_accounts::user Type"
...
Many of the type's parameters echo those of the standard [`user` type](/puppet/3.4/reference/type.html#user).
