---
layout: default
title: "PE 3.3 » Console » Event Inspector"
...
You can export data in the right pane to a CSV file using the __Export table as CSV__ link at the top right of the pane.
