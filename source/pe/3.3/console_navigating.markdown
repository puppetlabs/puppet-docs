---
layout: default
title: "PE 3.3 » Console » Navigating"
...
You can export node lists, reports, and inventory tables to a CSV file using the __Export as CSV__ link at the top right of the table.
