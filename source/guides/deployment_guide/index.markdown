...
While it is also possible to run masterless, this is an advanced method that is rarely done with PE. Once you have worked with Puppet at greater length, you can evaluate some of the discussions around the various ways you can run masterless.
