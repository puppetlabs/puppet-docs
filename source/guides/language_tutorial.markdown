...
(/guides/more_language.html) for further information.
...
[Modules Page](/guides/modules.html)
...
In these cases, writing an [External Nodes](/guides/external_nodes.html)
...
The [Extend Language Tutorial](/guides/more_language.html) offers more
...
about the language by browsing through [Puppet Modules](/guides/modules.html)
 created by others.
