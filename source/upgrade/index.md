...
**Note:** If you are looking for information about upgrading from Puppet 4.x to the latest, see the [ minor upgrades section of the Puppet documentation](./puppet/4.6/reference/upgrade_minor.html). For upgrading PE to the latest from 2015.2 or newer, see [Upgrading PE: monolithic](./pe/2016.2/upgrade_mono.html).
