...
[file_mode]: /puppet/latest/reference/type.html#file-attribute-mode
[where]: /puppet/latest/reference/whered_it_go.html
[reserved]: /puppet/latest/reference/lang_reserved.html
[numeric]: /puppet/latest/reference/lang_data_number.html
...
The full behavior is [defined in the documentation](/puppet/latest/reference/lang_expressions.html#in).

### Comparing data types

Different [data types](/puppet/latest/reference/lang_data.html) can't be compared as if they're the same data type anymore. This is most noticeable when comparing numbers to strings.
...
This will change any existing strings that are supposed to have literal double backslashes in them; you'll need to change them to quadruple backslashes. Read more about this behavior in the [language page about strings](/puppet/latest/reference/lang_data_string.html#single-quoted-strings).
...
Only certain functions are allowed to be called without parentheses. Read the [documentation on functions](/puppet/latest/reference/lang_functions.html) to learn when parentheses can be omitted.
...
Removal of `import` means you'll have to use a directory as your main manifest to recreate this functionality. Read the [Main Manifest](/puppet/latest/reference/dirs_manifest.html) page to learn more about this method.
