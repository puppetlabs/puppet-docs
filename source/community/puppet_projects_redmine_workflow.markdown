...
1. Check the ticket makes sense - is it clear what the requester wants?
   ...
   d. Is it assigned to the right category and does it have descriptive keywords?
   e. Is the output/code/log data clear and structured (you can edit this by updating the ticket and clicking the "More" button next to the "Change properties" line)
