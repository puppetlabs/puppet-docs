---
layout: default
title: puppet certificate Man Page
---
...
<pre><code>Deletes a certificate. This action currently only works on the local CA.
</code></pre>
...
<pre><code>  A string that appears to be (but isn't) an x509 certificate.
</code></pre></dd>
</dl>
