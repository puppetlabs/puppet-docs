...
<p>puppet status destroy [--terminus TERMINUS] [--extra HASH] <var>key</var></p>
...
<p>puppet status [--terminus TERMINUS] [--extra HASH] <var>dummy_text</var></p>
...
<var>--listen</var> option, you can set set the global <var>--server</var> and <var>--masterport</var>
...
<a data-bare-link="true" href="http://docs.puppetlabs.com/guides/rest_auth_conf.html">http://docs.puppetlabs.com/guides/rest_auth_conf.html</a> for more details.</p>

<p>Although this action always returns an unnamed status object, it requires a
dummy argument. This is a known bug.</p></dd>
...
<p>puppet status save [--terminus TERMINUS] [--extra HASH] <var>key</var></p>
...
<p>puppet status search [--terminus TERMINUS] [--extra HASH] <var>query</var></p>
...
<p>$ puppet status find x --terminus rest</p>
