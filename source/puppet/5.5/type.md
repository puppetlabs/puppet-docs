...
Multiple `exec` resources can use the same `command` value; Puppet only uses the resource title to ensure `exec`s are unique."
...
<pre><code>yumrepo { 'resource title':
  ...
  <a href="#yumrepo-attribute-target">target</a>                       =&gt; <em># The target parameter will be enabled in a future </em>
  ...
  <a href="#yumrepo-attribute-username">username</a>                     =&gt; <em># Username to use for basic authentication to a...</em>
  # ...plus any applicable <a href="{{puppet}}/metaparameter.html">metaparameters</a>.
}</code></pre>
...
<h4 id="yumrepo-attribute-password">password</h4>
...
<h4 id="yumrepo-attribute-username">username</h4>
