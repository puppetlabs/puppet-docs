...
[master_http]: /references/3.7.latest/developer/file.http_api_index.html
...
The Puppet master provides an HTTP interface. When requesting or submitting anything to the master, the agent will make an HTTPS request to one of those endpoints.
