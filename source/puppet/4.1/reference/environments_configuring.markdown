...
[(See also: Full description of `default_manifest` setting.)](/references/4.1.latest/configuration.html#defaultmanifest)
...
[(See also: Full description of `environment_timeout` setting.)](/references/4.1.latest/configuration.html#environmenttimeout)
