...
[man]: /puppet/3.7/reference/man/apply.html
...
[http_report]: /puppet/3.7/reference/report.html#http
[puppetdb]: /puppetdb/latest
[report handlers]: /puppet/3.7/reference/report.html
[reports_setting]: /puppet/3.7/reference/configuration.html#reports
...
To disable reporting and avoid taking up disk space with the `store` report handler, you can set [`report = false`](/puppet/3.7/reference/configuration.html#report) in [puppet.conf][].
