...
In earlier versions of Puppet, you could import manifests into site.pp. However, the `import` keyword was deprecated in Puppet 3.6 and will be removed completely in Puppet 4. Please see [Language: Importing Manifests][import] for deprecation details and alternative solutions.
