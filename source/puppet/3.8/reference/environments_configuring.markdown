...
[(See also: Full description of `default_manifest` setting.)](/puppet/3.8/reference/configuration.html#defaultmanifest)
...
[(See also: Full description of `environment_timeout` setting.)](/puppet/3.8/reference/configuration.html#environmenttimeout)
