...
* [`async_storeconfigs`](/puppet/3.8/reference/configuration.html#asyncstoreconfigs)
* [`dbadapter`](/puppet/3.8/reference/configuration.html#dbadapter)
* [`dbconnections`](/puppet/3.8/reference/configuration.html#dbconnections)
* [`dblocation`](/puppet/3.8/reference/configuration.html#dblocation)
* [`dbmigrate`](/puppet/3.8/reference/configuration.html#dbmigrate)
* [`dbname`](/puppet/3.8/reference/configuration.html#dbname)
* [`dbpassword`](/puppet/3.8/reference/configuration.html#dbpassword)
* [`dbport`](/puppet/3.8/reference/configuration.html#dbport)
* [`dbserver`](/puppet/3.8/reference/configuration.html#dbserver)
* [`dbsocket`](/puppet/3.8/reference/configuration.html#dbsocket)
* [`dbuser`](/puppet/3.8/reference/configuration.html#dbuser)
* [`queue_source`](/puppet/3.8/reference/configuration.html#queuesource)
* [`queue_type`](/puppet/3.8/reference/configuration.html#queuetype)
* [`rails_loglevel`](/puppet/3.8/reference/configuration.html#railsloglevel)
* [`railslog`](/puppet/3.8/reference/configuration.html#railslog)
* [`thin_storeconfigs`](/puppet/3.8/reference/configuration.html#thinstoreconfigs)
...
* [`inventory_port`](/puppet/3.8/reference/configuration.html#inventoryport)
* [`inventory_server`](/puppet/3.8/reference/configuration.html#inventoryserver)
* [`inventory_terminus`](/puppet/3.8/reference/configuration.html#inventoryterminus)
...
* [`allow_variables_with_dashes`](/puppet/3.8/reference/configuration.html#allowvariableswithdashes)
...
* [`catalog_format`](/puppet/3.8/reference/configuration.html#catalogformat)
...
This setting is replaced by the [`preferred_serialization_format`](/puppet/3.8/reference/configuration.html#preferredserializationformat) setting.

### `dynamicfacts`

* [`dynamicfacts`](/puppet/3.8/reference/configuration.html#dynamicfacts)
...
* [`ignoreimport`](/puppet/3.8/reference/configuration.html#ignoreimport)
...
* [`manifestdir`](/puppet/3.8/reference/configuration.html#manifestdir)
...
When given a relative path, the [`template` function](/puppet/3.8/reference/function.html#template) will try to find templates in this directory before trying to find them in modules.
