...
Structure of an environment hiera.yaml file:
...
Note that `data_hash: yaml_data` and `datadir: data` are the default settings.

A more advanced example of a hiera.yaml file:
