...
[user]: /puppet/4.2/reference/type.html#user
[groups]: /puppet/4.2/reference/type.html#user-attribute-groups
[auth_membership_user]: /puppet/latest/reference/type.html#user-attribute-auth_membership
[group]: /puppet/4.2/reference/type.html#group
[members]: /puppet/4.2/reference/type.html#group-attribute-members
...
* [`name`](/puppet/4.2/reference/type.html#user-attribute-name)
* [`ensure`](/puppet/4.2/reference/type.html#user-attribute-ensure)
* [`comment`](/puppet/4.2/reference/type.html#user-attribute-comment)
* [`groups`](/puppet/4.2/reference/type.html#user-attribute-groups) --- note that you can't use the `gid` attribute.
* [`home`](/puppet/4.2/reference/type.html#user-attribute-home)
* [`managehome`](/puppet/4.2/reference/type.html#user-attribute-managehome)
* [`password`](/puppet/4.2/reference/type.html#user-attribute-password) --- note that passwords can only be specified in cleartext, since Windows has no API for setting the password hash.
...
* [`name`](/puppet/4.2/reference/type.html#group-attribute-name)
* [`ensure`](/puppet/4.2/reference/type.html#group-attribute-ensure)
* [`members`](/puppet/4.2/reference/type.html#group-attribute-members)
