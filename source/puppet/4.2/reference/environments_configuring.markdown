...
[disable_per_environment_manifest]: /puppet/4.2/reference/configuration.html#disableperenvironmentmanifest
...
[(See also: Full description of `default_manifest` setting.)](/puppet/4.2/reference/configuration.html#defaultmanifest)
...
[(See also: Full description of `environment_timeout` setting.)](/puppet/4.2/reference/configuration.html#environmenttimeout)
