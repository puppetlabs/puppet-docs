...
If you need to convert numbers to non-decimal string representations, you can use [the `printf` function.](/puppet/4.2/reference/function.html#printf)
...
* Use [the `scanf` function](/puppet/4.2/reference/function.html#scanf) to manually extract numbers from strings. This function can also account for surrounding non-numerical text.
