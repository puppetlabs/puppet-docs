...
[man]: /references/4.2.latest/man/apply.html
...
[http_report]: /references/4.2.latest/report.html#http
[puppetdb]: /puppetdb/latest
[report handlers]: /references/4.2.latest/report.html
[reports_setting]: /references/4.2.latest/configuration.html#reports
...
To disable reporting and avoid taking up disk space with the `store` report handler, you can set [`report = false`](/references/4.2.latest/configuration.html#report) in [puppet.conf][].
