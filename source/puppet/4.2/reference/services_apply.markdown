...
[man]: /puppet/4.2/reference/man/apply.html
[resource type reference]: /puppet/4.2/reference/type.html
[environments]: ./environments.html
[main manifest]: ./dirs_manifest.html
[manifest_setting]: /puppet/4.2/reference/configuration.html#manifest
[env_main_manifest]: ./environments.html#manifests-directory--main-manifest
[modules]: ./modules_fundamentals.html
[enc]: /guides/external_nodes.html
[http_report]: /puppet/4.2/reference/report.html#http
[puppetdb]: /puppetdb/latest
[report handlers]: /puppet/4.2/reference/report.html
[reports_setting]: /puppet/4.2/reference/configuration.html#reports
...
To disable reporting and avoid taking up disk space with the `store` report handler, you can set [`report = false`](/puppet/4.2/reference/configuration.html#report) in [puppet.conf][].
