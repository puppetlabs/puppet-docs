...
[func_ref]: /puppet/4.2/reference/function.html
...
[template]: /puppet/4.2/reference/function.html#template
[include]: /puppet/4.2/reference/function.html#include
[each]: /puppet/4.2/reference/function.html#each
...
* [`include`](/puppet/4.2/reference/function.html#include) --- includes given classes in catalog
* [`require`](/puppet/4.2/reference/function.html#require) --- includes given classes in the catalog and adds them as a dependency of the current class or defined resource
* [`contain`](/puppet/4.2/reference/function.html#contain) --- includes given classes in the catalog and contains them in the current class
* [`realize`](/puppet/4.2/reference/function.html#realize) --- makes a virtual resource real
* [`tag`](/puppet/4.2/reference/function.html#tag) --- adds the specified tag(s) to the containing class or defined resource

### Logging Statements

* [`debug`](/puppet/4.2/reference/function.html#debug) --- logs message at debug level
* [`info`](/puppet/4.2/reference/function.html#info) --- logs message at info level
* [`notice`](/puppet/4.2/reference/function.html#notice) --- logs message at notice level
* [`warning`](/puppet/4.2/reference/function.html#warning) --- logs message at warning level
* [`err`](/puppet/4.2/reference/function.html#err) --- logs message at error level

Although there are a few additional logging functions, they cannot be called as statements.

### Failure Statements

* [`fail`](/puppet/4.2/reference/function.html#fail) --- logs error message and aborts compilation
