...
[man]: /puppet/4.3/reference/man/apply.html
...
[http_report]: /puppet/4.3/reference/report.html#http
[puppetdb]: /puppetdb/latest
[report handlers]: /puppet/4.3/reference/report.html
[reports_setting]: /puppet/4.3/reference/configuration.html#reports
...
To disable reporting and avoid taking up disk space with the `store` report handler, you can set [`report = false`](/puppet/4.3/reference/configuration.html#report) in [puppet.conf][].
