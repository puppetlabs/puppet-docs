...
2. On any number of agent nodes, set [the `preferred_serialization_format` setting](/puppet/4.3/reference/configuration.html#preferredserializationformat) to `msgpack` (in the `[agent]` or `[main]` section of puppet.conf).
