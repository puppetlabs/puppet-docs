...
`template` function reference can be found here [https://docs.puppet.com/puppet/latest/function.html#template], and for `epp` [https://docs.puppet.com/puppet/latest/function.html#epp]
