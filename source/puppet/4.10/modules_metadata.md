...
<table>
  ...
  <tr>
    <td>`author`</td>
    <td>Required</td>
    <td>The person who gets credit for creating the module. If absent, this key defaults to the username portion of `name`.</td>
  </tr>
  <tr>
    <td>`license`</td>
    <td>Required</td>
...
* `types`: Resource type documentation generated by older versions of the Puppet module tool as part of `puppet module build`. **Remove this key from your `metadata.json`.**
