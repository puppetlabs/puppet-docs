...
**This page is autogenerated; any changes will get overwritten** *(last generated on 2017-05-17 16:08:02 -0700)*
...
During an inspect run, the file bucket server to archive files to if archive_files is set. Note that the `inspect` command is deprecated.

- *Default*: $server

### archive_files

During an inspect run, whether to archive files whose contents are audited to a file bucket. Note that the `inspect` command is deprecated.
...
- *Default*: /Users/nick/.puppetlabs/etc/puppet/hiera.yaml
...
- *Default*: Puppet/4.10.0 Ruby/2.4.0-p0 (x86_64-darwin15)
...
*This page autogenerated on 2017-05-17 16:08:02 -0700*
