...
[types]: /puppet/latest/reference/type.html
...
You can see the full list of all metaparameters in the [Metaparameter Reference](/puppet/latest/reference/metaparameter.html).
