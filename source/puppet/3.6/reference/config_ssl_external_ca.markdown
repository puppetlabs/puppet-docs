...
[verify_header]: /puppet/3.6/reference/configuration.html#sslclientverifyheader
[client_header]: /puppet/3.6/reference/configuration.html#sslclientheader
[ca_auth]: /puppet/3.6/reference/configuration.html#sslclientcaauth
...
Rack web servers must set a client request header, which the puppet master will check based on the [`ssl_client_header` setting](/puppet/3.6/reference/configuration.html#sslclientheader).
