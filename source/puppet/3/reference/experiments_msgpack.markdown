...
1. Install the [msgpack gem](http://rubygems.org/gems/msgpack) on your master and all agent nodes. (If you are using a Puppet Enterprise test environment, be sure to run `/opt/puppet/bin/gem install msgpack` instead of using the system gem command.)
