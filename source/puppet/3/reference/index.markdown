...
* "Generated References" links to documentation extracted from the Puppet source code, including the [resource type reference](/puppet/3.4/reference/type.html), the [function reference](/puppet/3.4/reference/function.html) the [metaparameter reference](/puppet/3.4/reference/metaparameter.html),the [report handler reference](/puppet/3.4/reference/report.html) and the [developer reference](/puppet/3.4/reference/developer/index.html).
