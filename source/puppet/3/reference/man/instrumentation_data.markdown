...
<h2 id="NAME">NAME</h2>
<p class="man-name">
  <code>puppet-instrumentation_data</code> - <span class="man-whatis">Manage instrumentation listener accumulated data.</span>
</p>
...
<p>This subcommand allows to retrieve the various listener data.</p>
...
<pre><code>The data of an instrumentation listener
</code></pre></dd>
